...
int main()
{
    ...
    for (int i=0;i<20;i++)
    {
        team_names[i]=new (char[100]); 
        cin >> team_names[i]; 
        out << team_names[i] << endl;
    } 
    cout<<endl;
    ...
    for (int i=0;i<20;i++)
    {
        stadium_names[i]=new (char[100]);
        cin >> stadium_names[i];
        out << stadium_names[i] << endl;
    }
    cout<<endl;    
    out.close();
    ...
    for (int i=0;i<20;i++)
    {
       in.getline(stadium_names[i],100,'\n');    //take input from file of one line
       cout << stadium_names[i] << endl;
    } 
